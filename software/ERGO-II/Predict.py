# Modified based on Github: https://github.com/IdoSpringer/ERGO-II
...
def get_model(dataset):
    ...
    curr_dir = os.getcwd()+"/software/ERGO-II"
    checkpoint_path = os.path.join(curr_dir, 'Models', 'version_' + version, 'checkpoints')
    ...
    args_path = os.path.join(curr_dir, 'Models', 'version_' + version, 'meta_tags.csv')
    ...
    train_pickle = curr_dir+'/Samples/' + model.dataset + '_train_samples.pickle'
